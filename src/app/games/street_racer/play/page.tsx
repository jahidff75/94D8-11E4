        ...
        <main className="flex-1 flex flex-col items-center justify-between relative bg-gray-600">
             <div className="w-full flex justify-between items-center bg-black/30 p-2 z-10">
                <div>
                    ...
                    <p className="text-2xl font-bold text-yellow-400">210 KPH</p>
                </div>
                <div>
            ...
            {/* Player Car */}
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 w-24 h-32 animate-car-bob">
                 <img src="https://assets.stickpng.com/images/580b585b2edb16999085521e.png" alt="Race Car" className="w-full h-full object-contain" />
            </div>

            {/* Opponent Car */}
             <div className="absolute bottom-32 left-3/4 -translate-x-1/2 z-10 w-20 h-28 opacity-80">
                 <img src="https://assets.stickpng.com/images/580b585b2edb16999085521e.png" alt="Race Car" className="w-full h-full object-contain -scale-x-100" />
             </div>

             <div className="absolute bottom-0 w-full p-4 flex justify-between z-20">
                <Button className="font-bold text-2xl px-8 py-8 rounded-full">LEFT</Button>
                <Button className="font-bold text-2xl px-8 py-8 rounded-full">RIGHT</Button>
            </div>
